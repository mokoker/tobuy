  ...
  <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand  d-none d-md-block  col-sm-3 col-md-2 mr-0" v-on:click.native="reset" to="/">karasayfa.com</router-link>
          <input class="form-control form-control-dark w-100" type="text" placeholder="Search"  v-model="filterText" @keyup.enter="doFilter" >
