<template>
  <div class="col-sm-6 mx-auto">
    <div class="form-group">
      ...
      <input class="form-control" id="inputEmail" v-model="user.email" placeholder="Email">
    </div>
    <div class="form-group">
      <label for="input">Password</label>
      <input class="form-control" id="inputPassword" v-model="user.password" placeholder="Password">
    </div>
